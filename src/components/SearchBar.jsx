    ...
    <div className="flex justify-center ">
      <div className=" w-full">
        <div className="relative flex ">
          ...
          />
          <button
            className="btn px-6 py-2.5  text-white font-medium text-xs leading-tight uppercase rounded shadow-md bg-yellow-600 hover:bg-yellow-800 hover:shadow-lg  transition duration-150 ease-in-out flex items-center"
            type="button"
            id="button-addon2"
          >
            <svg
